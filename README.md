...
- verb has a number of unique features, but you can also use verb to run any [gulp](https://github.com/gulpjs/gulp) plugin
...
Basic readme template, rendered using data in `package.json`:
...
For projects that need more than a readme for documentation, you can add a `verbfile.js` to the project and install verb locally with:
