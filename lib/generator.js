...
module.exports = function(verb, base) {
  var common = new DataStore('common-config');
  verb.use(middleware());
  ...
  verb.register('store', function(gen) {
    ...
    gen.task('del', function(cb) {
      ...
      keys.forEach(function(key) {
        console.log(log.red('  Deleted:'), key, common.get(key));
        common.del(keys);
      });
      cb();
    });
    ...
    gen.task('show', function(cb) {
      ...
      console.log();
      keys.forEach(function(key) {
        console.log(key + ': ' + log.cyan(common.get(key)));
      });
      console.log();
      cb();
    });
    ...
    gen.task('me', function(cb) {
      console.log();
      console.log('  Answers to the following questions will be stored in:', log.bold('~/.common-config.json'));
      console.log('  The stored values will be used later in (your) templates.');
      console.log(`  To skip a question, just hit ${log.bold('<enter>')}`);
      console.log();
      ...
      gen.ask('common', {save: false}, function(err, answers) {
        ...
        console.log();
        console.log(log.bold('    $ gen store:del'));
        console.log();
        console.log('  To update these values, run:');
        console.log();
        console.log(log.bold('    $ gen store:me'));
        console.log();
        cb();
      });
    });
