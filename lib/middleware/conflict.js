...
module.exports = function conflict_(verb) {
  ...
  return function (file, next) {
    ...
    var res = helpers(str);
    var conflicting = problematic(verb, file, res, config.verbose);
    var h = {};
    ...
    ctx.context = _.merge({}, verb.cache.data, file.locals, file.data);
    ctx.app = verb;

    file.locals = file.locals || {};
    file.locals.__ = file.locals.__ || {};

    // console.log('actual:', verb._.helpers)
