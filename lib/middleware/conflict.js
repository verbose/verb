...
module.exports = function conflict_(app) {
  ...
  return function (file, next) {
    ...
    for (var i = 0; i < conflicting.length; i++) {
      ...
      var asyncFn = app._.asyncHelpers[name];
      if (asyncFn) {
