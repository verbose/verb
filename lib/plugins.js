...
exports.init = function (verb) {
   ...
   */
  extendContext(verb, builtIns);

  /**
   * Run user-defined plugins
   */
  extendContext(verb, opts.plugins);

  verb.verbose.info(plugins);
  verb.verbose.info(_.keys(plugins).length + ' plugins registered.', colors.green('OK.'));
};