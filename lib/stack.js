...
var destObj = require('./plugins/dest-obj');
...
function createStack(verb, plugins) {
  return es.pipe.apply(es, _.reduce(plugins, function (acc, plugin) {
    if (plugin == null) {
