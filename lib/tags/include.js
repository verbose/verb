...
module.exports = function (phaser) {
  ...
  exports.include = function (patterns, options) {
    ...
    var local = '';
    if(opts.includes) {
      local = utils.lookup(opts.includes, patterns)
    };
    ...
    // If `knownIncludes` is defined, then includes
    // from the `readme-templates` library will not
    // be loaded by default and only the patterns
    // specified in the options will be used
