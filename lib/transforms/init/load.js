...
module.exports = function load_(verb) {
  ...
  var includes = tryRequire(verb.store.get('includes'), 'readme-includes');
  var badges = tryRequire(verb.store.get('badges'), 'readme-badges');
  var docs = tryRequire(verb.store.get('docs'), cwd('docs'));
