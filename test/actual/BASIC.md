...
> The most insanely useful markdown documentation generator on the planet. Verb uses Lo-Dash as the template engine and comes complete with more than 50 tags and filters, helpful utilites, includes, comment parsing, YAML front matter, plugins, mixins and much more! Use Verb to generate markdown docs, use Assemble to build HTML.
